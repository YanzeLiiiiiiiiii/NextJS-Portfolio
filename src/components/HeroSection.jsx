        ...
        <section className='grid grid-cols-1 lg:py-16 lg:grid-cols-12 lg:py16'>
            ...
            <motion.div
                ...
                <div>
                    ...
                    <Link href='/Resume.pdf' target='_blank' className='px-1 inline-block py-1 w-full sm:w-fit rounded-full bg-gradient-to-r from-primary-700 to-secondary-400 hover:bg-slate-800 text-white mt-3'>
